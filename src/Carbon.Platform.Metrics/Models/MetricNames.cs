namespace Carbon.Platform.Metrics
{
    ...
    {
        public static readonly Metric Compute                = new Metric(1, 1, "compute`units",             Delta, "nanoluna");
        public static readonly Metric Storage                = new Metric(1, 1, "storage/stored`bytes",      Delta, "byte/hours");
        public static readonly Metric Transfer               = new Metric(1, 1, "transfer`bytes",            Delta, "bytes");
        ...
        public static readonly Metric RequestsResponseTime   = new Metric(11, 1, "requests/response`time",   Delta, "count");
        ...
        // transfer/ingress:bytes
        // transfer/ingress:packets
